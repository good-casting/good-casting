...
public class ResembleTest {
    ...
    public void test1() {
        ...
        try {
            ...
            String imgFile = "/Users/kodongyoung/Desktop/아이린.jpg";
            ...
            if (br != null) {
                ...
                String confidence = celebObject.getString("confidence");

                System.out.println(facesArr.toString());

                System.out.println(elem.toString());

                System.out.println(celebObject.toString());

                System.out.println("resemble: " + resemble + " conf: " + confidence );
...
//                System.out.println("profile.getResemble() : " + profile.getResemble());

//                profileRepo.resembleUpdate(profile.getProfileId(), response.toString());
