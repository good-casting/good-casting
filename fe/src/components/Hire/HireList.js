...
import getHireList from '../../state/reducer/user.reducer'
...
const HireList = () => {
    const hires = useSelector(state => {
        console.log("state: " + JSON.stringify(state.hires))
    });
const dispatch = useDispatch();
    useEffect(() => {
        console.log(getHireList)
      dispatch(getHireList)
  }, [])
    return (
        <>
